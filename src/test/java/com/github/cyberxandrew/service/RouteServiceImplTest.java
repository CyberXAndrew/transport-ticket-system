...
//    @Mock private RouteRowMapper routeRowMapper;
//    @InjectMocks
...
//
//        when(jdbcTemplate.queryForObject(eq(sql), eq(new Object[]{routeId1}), any(RouteRowMapper.class)))
...
//
//        when(jdbcTemplate.query(eq(sql), any(RouteRowMapper.class)))
//                .thenReturn(routes);
//
...
//        String sql = "UPDATE routes SET name = ?, phone_number = ? WHERE id = ?";
//
//        Route routeToUpdate = new Route();
//        routeToUpdate.setId(routeId1);
//        routeToUpdate.setName("Some name");
//        routeToUpdate.setPhoneNumber("123456789");
//
...
//                .withRouteName("name")
//                .withRoutePhoneNumber("123456789").build();
...
//        when(jdbcTemplate.queryForObject(eq(sql1), eq(new Object[]{routeId1}), any(RouteRowMapper.class)))
//                .thenReturn(route);
...
//
//        when(jdbcTemplate.queryForObject(sql3, Integer.class, routeId1)).thenReturn(0);
//        when(jdbcTemplate.queryForObject(eq(sql1), eq(new Object[]{nonExistingId}), any(RouteRowMapper.class)))
